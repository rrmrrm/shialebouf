...
public:
	...
	MyQLine(const MyQLine& other);
	MyQLine& operator=(const MyQLine& other);
...
public:
  ...
  // doValidation= false esetén megendegjük, hogy invalid állapotba kerüljön a vonal. Erre LineComponentben a szegmensek mergelésekor van szükség
...
inline std::istream& operator>>(std::istream& is, MyQLine& ql){
	...
	//loadSharedPtr(is, ql.connText, CanvasElement_Type::TEXTBOXT);
	return is;
}
#endif // MYQLINE_H

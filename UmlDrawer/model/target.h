...
public:
	...
	AggregationT<CanvasElement> canvasElement;
...
public:
	...
	Target(int cX, int cY,
			AggregationT<CanvasElement> canvasElement_,
	...
	Target(QPoint cCoords, AggregationT<CanvasElement> canvasElement_, int cXcY_relToCanvasMarker)
	...
	Target(int x_inTarget_, int y_inTarget_, AggregationT<CanvasElement> canvasElement_)
		:	
	...
	/// az mint az előző, csak a koordinátát QPoint-ben veszi át
	Target(QPoint cCoords, AggregationT<CanvasElement> canvasElement_)
		:	Target(cCoords.x(), cCoords.y(), canvasElement_)
	{}
	Target()
		:	
		  Target(0,0, AggregationT<CanvasElement>())
	{}
